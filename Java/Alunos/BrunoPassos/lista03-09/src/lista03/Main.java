...
public class Main {
	...
	/*
	 * 9. Calcule o famoso número PI através da série infinita descoberta pelo
	 * grande matemático Leibniz. Calcule com precisão 0,01 e depois aumente a
	 * precisão para 0,0001. (EDUARDO)
	 */
