...
public class Importador {
    ...
    private Conta processaLinha(String linha) {
        ...
        conta.setNumeroDoBanco(linha.substring(0,5));
        conta.setNumeroDaAgencia(linha.substring(5,11));
        conta.setCpf(linha.substring(11,22));
        conta.setSaldoConta(Double.parseDouble(linha.substring(22,40))/100);
