...
public class Teste {
	...
	public static void main(String[] args) {
		Set<Atleta> atletas = new LinkedHashSet<Atleta>();
		...
		do {
			...
			if (r.nextBoolean()) {
				...
				if (r.nextBoolean()) {
					...
					atleta = new Atleta(nome, cpf, modalidade, medalhas[0], medalhas[1], medalhas[2]);
				}

				out.println(atleta.toString());
			}
			out.println("\t ↳ Adicionado ao Set? " + atletas.add(atleta));
